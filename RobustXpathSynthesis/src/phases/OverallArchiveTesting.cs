...
namespace RobustXpathSynthesis.src.phases
{
    class OverallArchiveTesting
    {
        ...
        //gets all subsets of size "subsetSize" of numbers 1....n
        private static IEnumerable<IEnumerable<int>> SequenceUpTo(int n, int i)
        {
            IEnumerable<int> sequence = Enumerable.Range(1, i);
            return new List<IEnumerable<int>>(new IEnumerable<int>[] { sequence });
        }
